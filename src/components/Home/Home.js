...
export default class Home extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "http://api.openweathermap.org/data/2.5/weather?id=5780026&APPID=4aea2c0142da5d54dc6312b1bf572955"
      )
      .then(res => {
    ...
    return (
      <div>
        ...
        <div className="home">
          ...
          <br/>
              <div style = {{fontSize: '2px'}}>{this.state.city} {this.state.weather}</div>
        </div>
      </div>
    );
  }
